# Functional check — chromium

| Check | Result | Detail |
| --- | --- | --- |
| fino-preview runs | ✅ | fox px 189→190, moved 448.9px |
| write A (2 strokes) is accepted | ✅ | advanced=true in 506ms, index 0→1, completed=1, userStrokes=ok |
