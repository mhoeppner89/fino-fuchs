# Functional check — webkit

| Check | Result | Detail |
| --- | --- | --- |
| fino-preview runs | ✅ | fox px 190→190, moved 385.3px |
| write A (2 strokes) is accepted | ✅ | advanced=true in 502ms, index 0→1, completed=1, userStrokes=ok |
