...
const CACHE_NAME = `${CACHE_PREFIX}v1.3.41`;
const APP_SHELL = [
  './',
  './index.html',
  './calibration.html',
  './calibration.css',
  './calibration.css?v=1.3.41',
  './styles.css',
  './styles.css?v=1.3.41',
  './manifest.webmanifest',
  './js/app.js',
  './js/app.js?v=1.3.41',
  './js/calibration.js?v=1.3.41',
  './js/curriculum.js?v=1.3.41',
  './js/drawing.js?v=1.3.41',
  './js/mini-games.js?v=1.3.41',
  './js/handwriting-template-data.js?v=1.3.41',
  './js/handwriting-stroke-data.js?v=1.3.41',
  './js/curriculum.js',
  './js/drawing.js',
  './js/stroke-validation.js',
  './js/stroke-validation.js?v=1.3.41',
  './js/mini-games.js',
