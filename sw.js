...
const CACHE_NAME = `${CACHE_PREFIX}v1.3.48`;
const APP_SHELL = [
  './',
  './index.html',
  './calibration.html',
  './calibration.css',
  './calibration.css?v=1.3.48',
  './styles.css',
  './styles.css?v=1.3.48',
  './manifest.webmanifest',
  './js/app.js',
  './js/app.js?v=1.3.48',
  './js/calibration.js?v=1.3.48',
  './js/curriculum.js?v=1.3.48',
  './js/drawing.js?v=1.3.48',
  './js/mini-games.js?v=1.3.48',
  './js/handwriting-template-data.js?v=1.3.48',
  './js/handwriting-stroke-data.js?v=1.3.48',
  './js/curriculum.js',
  './js/drawing.js',
  './js/mini-games.js',
