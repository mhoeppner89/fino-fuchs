...
const CACHE_NAME = `${CACHE_PREFIX}v1.3.45`;
const APP_SHELL = [
  './',
  './index.html',
  './calibration.html',
  './calibration.css',
  './calibration.css?v=1.3.45',
  './styles.css',
  './styles.css?v=1.3.45',
  './manifest.webmanifest',
  './js/app.js',
  './js/app.js?v=1.3.45',
  './js/calibration.js?v=1.3.45',
  './js/curriculum.js?v=1.3.45',
  './js/drawing.js?v=1.3.45',
  './js/mini-games.js?v=1.3.45',
  './js/handwriting-template-data.js?v=1.3.45',
  './js/handwriting-stroke-data.js?v=1.3.45',
  './js/curriculum.js',
  './js/drawing.js',
  './js/mini-games.js',
