...
import { StrokeProgress } from './stroke-validation.js?v=1.3.38';

import {
  CHARACTER_TEMPLATE_SHEETS,
  characterTemplateCrop,
} from './handwriting-template-data.js?v=1.3.38';
import { characterStrokeGeometry } from './handwriting-stroke-data.js?v=1.3.38';
import {
